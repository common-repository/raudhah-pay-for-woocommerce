...
/**
 * Plugin Name: Raudhah Pay for WooCommerce
 * Plugin URI:
...
function raudhahpay_init()
{
    ...
    class WC_Raudhahpay_Gateway extends WC_Payment_Gateway
    {
        ...
        public function __construct()
        {
            ...
            $this->method_title = __('Raudhahpay', 'raudhahpay');
        ...
        public function access_token_missing_message()
        {
            ...
            $message .= '<p>' . sprintf(__('<strong>Gateway Notice!</strong> You should inform your API Access Token in Raudhah Pay. %sClick here to configure!%s', 'raudhahpay'), '<a href="' . get_admin_url() . 'admin.php?page=wc-settings&tab=checkout&section=raudhahpay">', '</a>') . '</p>';
            $message .= '</div>';
            echo $message;
        }
        ...
        {
            $message = '<div class="error">';
            $message .= '<p>' . sprintf(__('<strong>Gateway Notice!</strong> You should inform your API Signature Key in Raudhah Pay. %sClick here to configure!%s', 'raudhahpay'), '<a href="' . get_admin_url() . 'admin.php?page=wc-settings&tab=checkout&section=raudhahpay">', '</a>') . '</p>';
            $message .= '</div>';
            echo $message;
        }
        ...
        {
            $message = '<div class="error">';
            $message .= '<p>' . sprintf(__('<strong>Gateway Notice!</strong> You should inform your Collection ID in Raudhah Pay. %sClick here to configure!%s', 'raudhahpay'), '<a href="' . get_admin_url() . 'admin.php?page=wc-settings&tab=checkout&section=raudhahpay">', '</a>') . '</p>';
            $message .= '</div>';
            echo $message;
        }
